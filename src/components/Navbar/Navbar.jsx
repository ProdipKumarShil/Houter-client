    ...
    <div className="bg-gradient-to-r bg-opacity-5 from-h-secondary to-h-primary mb-[30px]">
      <div className="max-w-screen-xl py-4 mx-auto p-2 flex items-center justify-between">
        ...
        <div className="md:flex items-center gap-6 hidden">
          ...
          <Link to='/blogs' className="text-white text-[14px] font-semibold px-4 py-2 border border-[#ffffff4d] rounded-badge bg-[#ffffff1a]">
            Blogs
          </Link>
          <Link to='/aboutUs' className="text-white text-[14px] font-semibold px-4 py-2 border border-[#ffffff4d] rounded-badge bg-[#ffffff1a]">
            About Us
          </Link>
          <Link
            to="/signUp"
